...
export function TransformForm({
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-xl font-bold text-zinc-100 mb-4">Position</h3>
      ...
      <div className="pt-6 border-t border-white/10">
        <h3 className="text-xl font-bold text-zinc-100 mb-4">Rotation</h3>
        ...
        <div className="space-y-3">
          ...
          <input
            ...
            className="w-full h-2 bg-white/10 rounded-full appearance-none cursor-pointer accent-blue-500 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-blue-500 [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-blue-400 [&::-webkit-slider-thumb]:cursor-grab [&::-webkit-slider-thumb]:active:cursor-grabbing"
          />
          ...
          <div className="flex gap-2 mt-3">
            {[{ label: '0°', val: 0 }, { label: '90°', val: Math.PI / 2 }, { label: '180°', val: Math.PI }, { label: '270°', val: 3 * Math.PI / 2 }].map(({ label, val }) => (
              <button
                ...
                className="flex-1 px-3 py-2 rounded-full text-xs font-medium border bg-white/5 border-white/10 text-zinc-300 hover:bg-white/10 hover:border-white/20 hover:text-white transition-colors duration-200"
              >
                {label}
              </button>
            ))}
